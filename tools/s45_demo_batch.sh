#!/usr/bin/env bash
# Session 45 -- demo after the eyeball-feedback fixes. N=1, 16 trials.
#
...
set -u
OUT=/mnt/ssd/Social_Navigation/trial_outputs/demo_s45
mkdir -p "$OUT"
...
echo "BATCH_S45_DEMO COMPLETE" >> "$RESULTS"
